(function($)
{
    $.widget( "ui.combobox", $.ui.autocomplete, 
        ...
        _renderFullMenu: function(source){
            ...
            ul.append(lis.join(""));
            ul.addClass("ui-combobox-dropdown");
            this._resizeMenu();
...
//                    self.menu.deactivate();
        ...
        {
        	/** Update hide select */
        	this.element.hide().val(value);
        	
        	/** Update visible text */
        	this.input.val(this.element.hide().find("option:selected").text());
        },
        ...
        _selectInit: function(){
            ...
            this.input = $( '<input type="text">' ).insertAfter( select )
